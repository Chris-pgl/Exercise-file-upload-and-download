...
public class FileStorageService {
    ...
    public String upload(MultipartFile file)throws IOException {
        ...
        if (finalDestination.exists()) throw new IOException("File conflict, file already exist!");
    ...
    public byte[] download(String fileName)throws IOException{
        ...
        if(!fileFromRepository.exists()) throw new IOException("file dies bit exist.");
